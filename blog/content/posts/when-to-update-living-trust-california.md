...
tags: ["living trust", "trust amendment", "estate planning", "California trust law", "trust update", "Glendale attorney"]
excerpt: "Created your living trust years ago and haven't touched it since? A Glendale estate planning attorney reveals 11 critical life events that require trust updates—and what happens if you don't update it."
featured: false
coverImage: "/images/blog/trust-amendment-update.jpg"
metaDescription: "When to update your California living trust: 11 life events requiring amendments. Glendale attorney explains costs, process, consequences. State Bar 208356."
---
...
**Why It Matters:**
California is a community property state. When you marry, any assets acquired during the marriage generally become community property—owned 50/50 with your spouse, regardless of whose name is on the title.
...
**Real-World Issue:**
If you remarry and don't update your trust, California law gives your surviving spouse certain rights that may conflict with your trust terms. This creates litigation—exactly what you created a trust to avoid.

### 2. Divorce or Legal Separation

**Critical Timing:**
California Family Code Section 6122.5 automatically revokes provisions in your trust benefiting your former spouse once the divorce is final. However, don't rely on this automatic revocation—it creates ambiguity and potential litigation.
...
**Why It Matters:**
Your trust likely doesn't automatically include children born or adopted after you created it unless you included specific language anticipating this.
...
**California Law Nuance:**
California Probate Code Section 21620 provides some protection for "pretermitted children" (unintentionally omitted), but it's far better to explicitly update your trust than rely on court interpretation.

### 4. Death of a Beneficiary

**What Happens:**
If a named beneficiary dies before you and you haven't updated your trust, what happens to their share depends on your trust language.
...
**Common Issue:**
I often see trusts with three children as equal beneficiaries. One child dies. Parents never update the trust. When the second parent dies, does the deceased child's share go to their children, or is it split between the two surviving siblings? Without clear trust language, this creates family disputes.

### 5. Change in Trustee Circumstances

**When to Act:**
Your chosen trustee or successor trustees may become unable or unwilling to serve due to:
- Death
...
**Critical Issue in California:**
Los Angeles County home values have increased dramatically. A Glendale home purchased for $300,000 in 2000 might be worth $1.2 million today. Your trust distribution plan that seemed fair 20 years ago might create significant imbalances now.

### 7. Purchase or Sale of Real Estate

**Why This Is Critical:**
Real estate is typically your largest asset and the primary reason you created a trust—to avoid probate on California real property.
...
**Common Mistake:**
You buy a new home and title it in your name instead of your trust name, thinking you'll transfer it later. You never do. That property goes through probate, defeating the entire purpose of your trust.

**Correct Process:**
1. Purchase property in trust name, OR
2. Immediately deed property to trust after purchase
3. Update Schedule A to list the property
4. Amend trust if the new property significantly changes your estate plan
...
**What to Do:**
Schedule periodic reviews with your estate planning attorney (I recommend every 3-5 years) to ensure your trust takes advantage of current laws and complies with new requirements.
...
You have broad discretion to distribute your trust assets as you wish (with community property limitations for spouses). However, clearly documenting your intent helps prevent will contests based on claims of undue influence or lack of capacity.
...
Create a special needs trust to preserve government benefit eligibility while supplementing their care.

**Starting or Selling a Business:**
Update trust to address business succession, valuation, and management.

**Becoming a Caregiver:**
Add provisions for compensation or larger distributions to children providing your care.

**Health Decline:**
Ensure trustee succession plan accounts for your potential incapacity.

**Charitable Intent Changes:**
Add or modify charitable bequests.
...
**When to Use:**
For specific, limited changes—updating beneficiaries, changing trustees, revising particular provisions.

**Process:**
1. Draft amendment document referencing original trust
2. Sign and date amendment
3. Notarize (recommended but not required for revocable trusts)
4. Keep with original trust document
5. Provide copy to successor trustees
...
**Process:**
1. Create completely new trust document
2. Maintain original trust name and date
3. Replace all previous terms with new provisions
4. Sign, date, and notarize
5. No need to retitle assets (trust name stays the same)
...
**Process:**
1. Execute revocation document
2. Create entirely new trust
3. Retitle all assets from old trust to new trust
...
**When It Makes Sense:**
Primarily for irrevocable trusts or when combining/separating trusts.
...
**Don't Have It?**
Your attorney should have a copy. If your attorney is unavailable, you may need to reconstruct the trust or create a new one.
...
**DIY Amendments:**
While California allows you to amend your own trust, I strongly advise against it. I've seen countless cases where well-intentioned DIY amendments created ambiguities, conflicts with other trust provisions, or didn't actually accomplish what the person intended.
...
Both grantors must sign if you created a joint trust.
...
**Real Example:**
Client divorced in 2010, died in 2023 with trust still naming ex-spouse as beneficiary. While California law revoked the ex-spouse provision, it created ambiguity requiring court interpretation, legal fees, and family conflict.
...
**Example:**
Trust created when your estate was $200,000 leaves specific dollar amounts to each child. Estate grows to $2 million. Specific dollar bequests now create massive imbalances you never intended.
...
Trust litigation over ambiguities or outdated provisions: $50,000-$300,000+
...
**Schedule your trust review consultation today.** Call **(818) 291-6217** or visit our [estate planning page](/estate-planning-questionnaire.html).
