...
tags: ["how to distribute trust assets", "trust distribution California", "trustee's deed", "distributing inheritance", "trust asset distribution", "California trust law", "Glendale attorney"]
excerpt: "Practical guide to distributing trust assets in California: How to transfer real estate, distribute cash, move investment accounts, divide personal property, and document everything properly."
featured: false
coverImage: "/images/blog/avoid-probate.jpg"
metaDescription: "How to distribute trust assets California: Transfer real estate with trustee's deed, distribute cash, move investments, divide personal property. Complete trustee guide. Glendale attorney."
---
...
☐ **120-day contest period has expired**
Calculate 120 days from when you sent the statutory notices. Don't distribute until this deadline passes.

☐ **All debts are paid**
Outstanding creditors can pursue beneficiaries if you distribute before paying valid debts.

☐ **Taxes are handled**
File all required returns and pay taxes due—or reserve sufficient funds.

☐ **Trust terms are clear**
Understand exactly what each beneficiary should receive.

☐ **Funds are reserved**
Keep enough for final administration expenses and unexpected claims.
...
1. Contact the brokerage/custodian
2. Request trust distribution paperwork
3. Complete transfer forms
4. Beneficiary opens account (if needed)
5. Investments transfer to beneficiary's account
...
1. Sell all holdings in the trust account
2. Wait for trades to settle (2 business days)
3. Distribute cash proceeds to beneficiaries
...
**If individuals are named as beneficiaries:**
The accounts pass directly to them outside the trust. The trustee's role is limited.

**If the trust is named as beneficiary:**
The accounts pass to the trust and must be distributed according to trust terms.
...
**Example:**
Trust says: House to Mary, investments to John, cash to Tom
