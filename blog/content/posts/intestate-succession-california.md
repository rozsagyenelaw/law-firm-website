...
1. **No will exists** at death
2. **Will is invalid** due to:
   - Improper execution (missing signatures, witnesses)
   - Lack of testamentary capacity
   - Undue influence or fraud
   - Successful will contest
3. **Will doesn't dispose of all property** (partial intestacy)
...
6. **Great-grandparents** and their descendants
7. **Predeceased spouse's next of kin**
8. **State of California** (escheat)
...
**Example:**
$1 million house purchased during marriage.
...
**Example:**
Married couple, no children. Decedent owns:
...
**Separate property:** 100% to spouse (if one child) OR 50% to spouse, 50% to children (if multiple children)
...
**Community property:** 100% to spouse
**Separate property:** 50% to spouse, 50% to ALL children

**Example:**
Decedent has two children from first marriage. Remarried with $1M community property home, $400K separate property.
...
**Community property:** 100% to spouse
**Separate property:** 50% to spouse, 50% to parents
...
**Community property:** 100% to spouse
**Separate property:** 50% to spouse, 50% to siblings
...
**Example:**
Three children: Anna, Ben, Carlos. Carlos predeceased, leaving two children.
- Anna: 1/3
- Ben: 1/3
...
**Example:**
Unmarried decedent, no children, both parents alive.
- Mother: 50%
- Father: 50%
...
**Example:**
John dies with three children: Alice, Bob, Carol.
Bob predeceased John, leaving two children (John's grandchildren).
...
**Example:**
Two full siblings, one half-sibling → each inherits 1/3.
...
1. **Unmarried partners** (not registered)
2. **Stepchildren** (unless adopted)
3. **Foster children** (unless adopted)
4. **Friends**
5. **Caregivers**
6. **Charities**
7. **Former spouses** (after divorce finalized)
8. **Pets** (cannot legally inherit)
...
- **[Died Without Will California](/blog/died-without-will-california/)** - Complete guide to the intestate probate process from start to finish.

- **[California Inheritance Laws Without Will](/blog/california-inheritance-laws-without-will/)** - Detailed scenarios for every family situation under intestate succession.

- **[How to File Probate in Los Angeles County](/blog/file-probate-los-angeles-county/)** - Filing intestate probate administration.

- **[California Executor Duties & Responsibilities](/blog/executor-duties-california/)** - What administrators do in intestate estates.

- **[How to Avoid Probate in California](/blog/avoid-probate-california/)** - Create estate plan to avoid intestacy problems entirely.
...
**Call (818) 291-6217** to schedule a consultation at my Glendale office, or complete our [probate questionnaire](/probate-intake-form.html) for intestate cases, or our [estate planning questionnaire](/estate-planning-questionnaire.html) to create your plan.
